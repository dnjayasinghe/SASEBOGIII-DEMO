...
namespace SASEBO_G_Checker {
  ...
  class Manager
  {
    ...
    //------------------------------------------------ controller_setup()
    public void init_controller(string st_num_text, string st_key, string samples, bool multipleAES  /*, string st_delay*/) 
	{
      int num_text = Convert.ToInt32(st_num_text);
      int sampleLength = Convert.ToInt32(samples);
     // int delayTime = Convert.ToInt32(st_delay);
      controller = (Controller)new Controller(module, num_text, st_key, sampleLength, multipleAES/*, delayTime*/);
    }
    ...
    public void set_delay(int delay) { controller.set_delay(delay); }

   public void set_multiAES(Boolean multiAES) { controller.set_multiAES(multiAES); }
        //************************************************ 
